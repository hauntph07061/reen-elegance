...
function Header() {
  ...
  return (
    <div className="fixed top-0 md:top-6 left-0 right-0 z-50 px-0 md:px-6 pointer-events-none">
      <header className={`max-w-7xl mx-auto bg-white rounded-none md:rounded-full h-[64px] md:h-[72px] px-4 md:px-8 flex items-center justify-between shadow-[0_4px_20px_rgba(0,0,0,0.05)] pointer-events-auto transition-all duration-300 ${
        isHomePage 
          ? 'border-b md:border-none border-gray-100' 
          : 'border-b md:border border-[#b2b59e]'
      }`}>
